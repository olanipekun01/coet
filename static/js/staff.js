...
const staffMembers = [
  ...
  {
    name: "Engr. Prof. Sesan Ppeter Ayodeji",
    qualification: "FNSE",
    ...
    <div class="overflow-hidden border rounded-lg">
      <div class="grid md:grid-cols-[200px_1fr] gap-6">
        <div class="bg-gray-100">
          <img src="../assets/${staff.image}" alt="${staff.name}" class="w-full h-full object-cover">
        </div>
        <div class="p-6">
